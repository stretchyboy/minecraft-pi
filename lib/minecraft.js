...
Minecraft.prototype.sendReceive = function (command, callback, ongoing) {
    var self = this;
    ...
    if(typeof ongoing == "undefined") {
      this.connection.once('data', callback);
    } else if (ongoing) {
...
Minecraft.prototype.eventsBlockHits = function(callback) {
    return this.sendReceive('events.block.hits()', callback, true);
};
