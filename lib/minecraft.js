...
Minecraft.prototype.getBlockName = function(id){ 
    var filtered = Object.keys(this.blocks).filter(function(element){return (this.blocks[element] === id);});
    if(filtered.length)
    {
        return filtered[0];
    }
...
Minecraft.prototype.setBlockV = function (P, id, data) {
...
Minecraft.prototype.setBlocksV = function (P1, P2, id, data) {
...
Minecraft.prototype.getHeightV = function (P, callback) {
    return this.sendReceive('world.getHeight(' + P.x + ',' + P.z + ')', function(h){var Q = P.clone(); Q.z = h; callback.call(null,Q);});
};
...
Minecraft.prototype.setCameraPositionV = function (P) {
...
Minecraft.prototype.getTileV = function (callback) {
    return this.sendReceive('player.getTile()', function(data){
            ...
            callback.call(null, playerposition);
});};
...
Minecraft.prototype.setTileV = function (P) {
...
Minecraft.prototype.getPosV = function (callback) {
...
Minecraft.prototype.directioncalcs = {
  "up":   function(pos, distance){return pos.offset(v(0,distance,0));},
  "down": function(pos, distance){return pos.offset(v(0,distance*-1,0));},
  "north":function(pos, distance){return pos.offset(v(0,0,distance));},
  "south":function(pos, distance){return pos.offset(v(0,0,distance*-1));},
  "west": function(pos, distance){return pos.offset(v(distance,0,0));},
  "east": function(pos, distance){return pos.offset(v(distance*-1,0,0));},
